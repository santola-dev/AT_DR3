...
public class App {
    ...
    public static void main(String[] args) {
        ...
        app.post("/produtos", App::criarProdutoHandler); // Cria o endpoint
        app.get("/produtos", App::listarProdutosHandler); // Lista os produtos existentes de uma lista
        app.get("/produtos/{nome}", App::buscarProdutoPorNomeHandler); // Busca entre os produtos de dita lista
    }
